  ...
  return (
    <div className='about'>
      ...
      <div className="about-right">
        <h2>Who We Are ?</h2>
        <p>PK has been providing Spoken English & Personality Development training since 2010. With 13+ years of experience, it has helped thousands of students globally, including professionals, teachers, doctors, and businessmen. The institute uses modern technology for effective training, such as audio-visual labs, software, and live online sessions</p>
